namespace GrindOMeter.UnitTests.Model
{
    using System.Collections.Generic;
    using System.Linq;
    using GrindOMeter.Model;
    ...
    public class ModelTests
    {
        ...
        public void GetAvailableEntitiesCalledOnCorrectAdaptor()
        {
            ...
            var avaiableItems = new List<IEntity>() { itemMock.Object };
        ...
        public void LoadTrackedEntities()
        {
            ...
            var itemAdaptorMock = new Mock<IEntityAdaptor>();
            itemAdaptorMock.Setup(adaptor => adaptor.GetAvailableEntities()).Returns(new List<IEntity>() { includedItem1, includedItem2, excludedItem });
            var currencyAdaptorMock = new Mock<IEntityAdaptor>();
            currencyAdaptorMock.Setup(adaptor => adaptor.GetAvailableEntities()).Returns(new List<IEntity>() { excludedCurrency, includedCurrency });
            ...
            entityStorageMock.Setup(storage => storage.LoadTrackedEntities())
                .Returns(new List<TrackedEntity>()
                {
            ...
            Assert.AreEqual(1, trackedEntities.Count(e => e == includedItem1));
            Assert.AreEqual(1, trackedEntities.Count(e => e == includedItem2));
            Assert.AreEqual(1, trackedEntities.Count(e => e == includedCurrency));
        }
