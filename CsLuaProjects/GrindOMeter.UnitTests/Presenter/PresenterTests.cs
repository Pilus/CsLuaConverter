namespace GrindOMeter.UnitTests.Presenter
{
    using System;
    ...
    public class PresenterTests
    {
        ...
        public void PresenterCallsLoadTrackedEntitiesAndDisplaysThemInTheView()
        {
            ...
            this.modelMock.Setup(model => model.LoadTrackedEntities()).Returns(new List<IEntity>() { item, currency });
        ...
        public void PresenterProvidesHandlesTrackClickAndTrackableEntitySelection()
        {
            ...
            this.modelMock.Setup(model => model.GetAvailableEntities(EntityType.Item)).Returns(new List<IEntity>() { item1, item2 });
            this.modelMock.Setup(model => model.GetAvailableEntities(EntityType.Currency)).Returns(new List<IEntity>() { currency });
