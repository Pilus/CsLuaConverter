namespace WoWSimulator.UISimulation.UiObjects
{
    ...
    public class Script<T1,T2> : IScript<T1,T2>
    {
        ...
        private readonly Dictionary<T1, List<Action<INativeUIObject, object, object, object, object>>> hookedScripts = new Dictionary<T1, List<Action<INativeUIObject, object, object, object, object>>>();
        private T2 self;
