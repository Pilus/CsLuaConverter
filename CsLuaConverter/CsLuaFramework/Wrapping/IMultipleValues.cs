namespace CsLuaFramework.Wrapping
{
    ...
    public interface IMultipleValues<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>
    {
        T1 Value1 { get; }
        T2 Value2 { get; }
        T3 Value3 { get; }
    ...
    public interface IMultipleValues<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>
    {
        T1 Value1 { get; }
        T2 Value2 { get; }
        T3 Value3 { get; }
    ...
    public interface IMultipleValues<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>
    {
        T1 Value1 { get; }
        T2 Value2 { get; }
        T3 Value3 { get; }
