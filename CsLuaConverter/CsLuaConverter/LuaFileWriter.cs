namespace CsLuaConverter
{
    ...
    static class LuaFileWriter
    {
        ...
        public static IList<CodeFile> GetLuaFiles(Dictionary<string, Action<IndentedTextWriter, IProviders>> nameSpaces, IProviders providers, string name, bool requiresCsLuaMetaHeader, string projectPath)
        {
            ...
            if (nameSpaces != null)
            {
                foreach (var nameSpacePair in nameSpaces)
                {
                    ...
                    nameSpacePair.Value(new IndentedTextWriter(textWriter), providers);
                    files.Add(new CodeFile
                    {
