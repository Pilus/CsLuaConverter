namespace CsLuaSyntaxTranslator.SyntaxExtensions
{
    ...
    public static class MemberExtensions
    {
      ...
      x EnumMemberDeclarationSyntax
        ...
        {
            var isStatic = syntax.Modifiers.Any(n => GetKind(n).Equals(SyntaxKind.StaticKeyword));
            var isConst = syntax.Modifiers.Any(n => GetKind(n).Equals(SyntaxKind.ConstKeyword));
        ...
        private static SyntaxKind GetKind(SyntaxToken token)
        {
