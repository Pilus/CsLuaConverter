namespace CsLuaCompiler
{
    ...
    internal class CsProject
    {
        ...
        private CustomAttributeData csLuaAddOnAttribute;
        ...
        {
            if (this.customAttributes.Any(att => att.AttributeType.Equals(typeof(CsLuaLibraryAttribute))))
            {
                return ProjectType.CsLuaLibrary;
            }

            var csLuaAddOnAttribute = this.assembly.GetTypes()
                .Select(t => t.CustomAttributes.FirstOrDefault(a => a.AttributeType.Equals(typeof(CsLuaAddOnAttribute)))).FirstOrDefault();
